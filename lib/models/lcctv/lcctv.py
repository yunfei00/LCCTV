...
from lib.models.lcctv.vit_cae_async import CAE_Base_patch16_224_Async
from lib.utils.box_ops import box_xyxy_to_cxcywh
from lib.test.utils.hann import hann2d

from lib.models.skipatt.vit_skipat import skipat_base_patch16_224
...
class Lcctv(nn.Module):
    """ This is the base class for Lcctv"""
...
def build_Lcctv(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(
        __file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')

    if cfg.MODEL.PRETRAIN_FILE and ('Lcctv' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if 'Lcctv' in cfg.MODEL.PRETRAIN_FILE and training:
