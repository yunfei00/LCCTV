...
def _create_vision_transformer(pretrained=False, **kwargs) -> VisionTransformerCE: 
...
def vit_base_patch16_224_ce(pretrained=False, **kwargs) -> VisionTransformerCE:
...
def vit_large_patch16_224_ce(pretrained=False, **kwargs) -> VisionTransformerCE:
