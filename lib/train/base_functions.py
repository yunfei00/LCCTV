...
# datasets related
from lib.train.dataset import Lasot, Got10k, MSCOCOSeq, ImagenetVID, TrackingNet, UAV
...
def build_dataloaders(cfg, settings):
    ...
    transform_train_template = tfm.Transform(
                                    # tfm.RandomAffine(max_rotation=10),
